...
#### Unlabeled data <br />
The unlabeled dispersion curves are extracted from Qiu et al. (2019). They are stored as a 3-D matrix in .npy format for simplicity <br />

Test_data_Qiu.npy

Test_data_Qiu_sigma.npy
